...
export default function SecondaryHeader() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white shadow-lg py-2 transition-all duration-300">
      <div className="container mx-auto px-4 flex items-center justify-between">
        <Link href="/" className="flex items-center space-x-2">
          <div className="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center">
            <i className="ri-fire-fill text-white text-xl"></i>
          </div>
          <span className="text-xl font-pacifico text-gray-900">ورزشی پرو</span>
        </Link>
            ...
            item.subMenu ? (
              <div key={index} className="relative group">
                <button
                  ...
                  className="flex items-center space-x-1 space-x-reverse hover:text-orange-500 transition-colors duration-300 text-gray-900"
                >
              ...
              <Link
                key={index}
                href={item.href}
                className="hover:text-orange-500 transition-colors duration-300 text-gray-900"
              >
                {item.label}
              </Link>
            )
        ...
        <div className="flex items-center space-x-4 space-x-reverse">
          <button
            ...
            className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300 text-gray-900"
          >
            <i className="ri-search-line text-xl"></i>
          </button>

          <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300 relative text-gray-900">
            <Link
              href={"/cart"}
          ...
          <div className="relative group">
            <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300 text-gray-900">
          ...
          <button
            ...
            className="md:hidden w-10 h-10 flex items-center justify-center rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300 text-gray-900"
          >
            <i
              className={`text-xl ${
